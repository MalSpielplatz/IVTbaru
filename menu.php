...
<div class="sidebar-heading">
 ...
 <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="master" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="master.php">Data Barang</a>
            <a class="collapse-item" href="input-master.php">Input PRODUK BARU</a>
          </div>
        </div>
      </li>
	  ...
	  <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ingoing" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="ingoing" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">

            <a class="collapse-item" href="input-produksi.php">Input PRODUKSI</a>
