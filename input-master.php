    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Input Produk ke gudang</h1>
        ...
        $satuan        = $_POST['satuan'];
        $harga         = $_POST['harga'];
        $bahan         = $_POST['id_produk'];
		


        $query = mysqli_query($koneksi, "INSERT INTO produk (id_produk, nama_produk, jenis_barang, kategori, qty, satuan, harga, bahan) VALUES ('$id_produk', '$nama_produk', '$jenis_barang', '$kategori', '$qty', '$satuan', '$harga', '$id_produk'  )");
        if ($query){
...
<div class="form-group">
                          <div class="input-group mb-6">
                              <div class="col-sm-6">
                              <!-- <label class="col-sm-2 col-sm-2 control-label">Satuan</label><br> -->
                              <select class="custom-select" id="satuan" name="satuan"> <label class="col-sm-2 col-sm-2 control-label">Satuan</label><br>
    <option selected>dalam satuan apa?</option>
