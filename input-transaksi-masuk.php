...
$entry       = $_SESSION['fullname'];
                    ...
                    $insert = mysqli_query($koneksi, "INSERT INTO transaksi(tanggal, id_produk, nama_produk, qty, satuan, status, entry)
                     VALUES('$tanggal', '$id_produk', '$nama_produk', '$qty', '$satuan', '$status', '$entry' )") or die(mysqli_error($koneksi));
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal style-form" action="input-transaksi-keluar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id Produk 
                                <!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">
                                <b>Cari</b> <span class="glyphicon glyphicon-search"></span>
                                </button> -->
                              </label>
                              <div class="col-sm-3">
